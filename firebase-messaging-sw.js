// firebase-messaging-sw.js — dùng cho app CoDien (Kỹ Thuật Cơ Điện)
// Đặt file này CÙNG THƯ MỤC với CoDien-V*.html trên GitHub Pages.
...
messaging.onBackgroundMessage((payload) => {
  const title = payload.notification?.title || "Kỹ Thuật Cơ Điện";
  const options = {
    body: payload.notification?.body || "",
    icon: 'https://cdn-icons-png.flaticon.com/512/2920/2920349.png',
    badge: 'https://cdn-icons-png.flaticon.com/512/2920/2920349.png',
    data: payload.data || {}
  };
